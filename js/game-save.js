...
function _buildSaveObject() {
  ...
  return {
    ...
    _tech: {
      ...
      bijouxProgress: gameState.bijouxProgress || { casesMarquees: 0 },
      bijouxGloirePrev: gameState.bijouxGloirePrev || 0,
      bijouxCaseCeTour: gameState.bijouxCaseCeTour || false,
      ...
      usedOneTimeEffects:     gameState.usedOneTimeEffects     || [],
...
function _applyImport(raw) {
  ...
  gameState = {
    ...
    bijouxProgress:   save.bijouxProgress   || { casesMarquees:0 },
    bijouxGloirePrev: save.bijouxGloirePrev || 0,
    bijouxCaseCeTour:  save.bijouxCaseCeTour  || false,
    ...
    usedOneTimeEffects:    save.usedOneTimeEffects    || [],
